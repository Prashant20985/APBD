...
namespace Tutorial_7.Models
{
    public partial class s20985Context : DbContext
    {
        public s20985Context()
        {
        }

        public s20985Context(DbContextOptions<s20985Context> options)
            : base(options)
        {
        }
